      ...
      >
        <div className='container flex flex-wrap justify-between items-center mx-auto'>
          ...
          <div
            ...
            id='mobile-menu'
          >
            <ul className='flex flex-col  mt-12 md:mt-0   md:flex-row md:space-x-8   text-white'>
              <li>
                <Link
                  to='#about'
              ...
              <li>
                <Link to='#contact' className='block py-2 pr-4 pl-3   md:p-0  '>
                  Contact
                </Link>
              </li>
            </ul>
